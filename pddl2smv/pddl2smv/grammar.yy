...
%token DEFINE DOMAIN COL_DOMAIN REQUIREMENTS TK_STRIPS TK_TYPING TYPES CONSTANTS PREDICATES ACTION PARAMETERS PRECONDITION EFFECT AND NOT PROBLEM OBJECTS INIT GOAL INITNODE TRANSITIONS TK_ALW TK_IFF TK_EVT TK_HYPHEN TK_EQ TK_LTL_AND TK_LTL_OR TK_EXCL TK_IMPL TK_UNTIL TK_RELEASE TK_NEXT

%token <string_ptr> NAME VARIABLE ERROR
...
%type <problem_ptr> problem
%type <ltl_spec_ptr> ltl_spec
...
problem:
	'(' DEFINE '(' PROBLEM NAME ')' '(' COL_DOMAIN NAME ')' object_decl init '(' GOAL ltl_spec ')' ')'{
		...
		$$ = new Problem(*$5, domain, *requirements, *$11, *$12, $15);
